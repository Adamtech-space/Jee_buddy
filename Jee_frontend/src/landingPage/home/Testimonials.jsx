  ...
  const testimonials = [
    {
      ...
      content: "JEE Buddy helped me understand complex concepts through their interactive learning platform. The AI-powered assistance was available 24/7 to clear my doubts.",
    ...
    },
    {
      name: "Priya Sharma",
      role: "JEE Mains 2023",
      content: "The practice tests and personalized feedback helped me improve my weak areas. I could track my progress and focus on topics that needed more attention.",
    ...
    },
    {
      name: "Amit Patel",
      role: "JEE Advanced 2023",
      content: "The structured study material and mock tests were exactly what I needed. The platform's analytics helped me understand my preparation level clearly.",
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="relative">
                <svg className="absolute -top-4 -left-2 w-8 h-8 text-blue-600/20" fill="currentColor" viewBox="0 0 32 32">
