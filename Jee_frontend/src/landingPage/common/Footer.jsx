const Footer = () => {
  ...
  return (
    <footer className="relative bg-black py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom,_var(--tw-gradient-stops))] from-blue-900/10 via-black to-black" />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-6 mb-12">
            ...
            <a href="https://linkedin.com/company/jeebuddy" 
               target="_blank" 
               rel="noopener noreferrer"
               className="text-gray-400 hover:text-blue-400 transition-all duration-300 transform hover:scale-110">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:contact@jeebuddy.com"
               className="text-gray-400 hover:text-blue-400 transition-all duration-300 transform hover:scale-110">
